...
HD_PWD='C:/ZynqBerry/te0726-zynqberrydemo1-vivado_2017.1-build_03_20170705132546/zynqberrydemo1/vivado/zynqberrydemo1.runs/zsys_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zsys_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zsys_xbar_0.tcl
