...
HD_PWD='/home/linuxlabb/Range_Sensor_Basys3/Range_Sensor_Basys3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Range_Sensor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Range_Sensor.tcl -notrace
