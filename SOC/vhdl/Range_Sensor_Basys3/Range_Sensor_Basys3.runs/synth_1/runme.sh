...
HD_PWD='/home/linuxlabb/Range_Sensor_Basys3/Range_Sensor_Basys3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Range_Sensor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Range_Sensor.tcl
